                ...
                <form method="post">
                  <div class="">
                    <div class="mb-4 bg-gray-200 rounded p-2">
                      ...
                      <input type="text" id="name" name="name" value="<?php echo $categoryDetails['name']; ?>" class="p-2 border rounded w-full" required>
                    </div>
                    <button type="submit" class="border border-indigo-400 rounded-3xl text-gray-600 px-4 py-1 hover:bg-indigo-400 transition hover:text-gray-100">
                      Update
                    </button>
                  </div>
                </form>
