...
<div id="alert-1" class="absolute top-10 w-6/12  flex items-center justify-center self-center p-4 mb-4 text-blue-800 rounded-lg bg-blue-50 dark:bg-gray-800 dark:text-blue-400" role="alert">
