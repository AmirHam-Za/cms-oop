...
<body>
  ...
  <div class="w-full flex justify-center items-center h-full w-full flex justify-center items-center h-full bg-gradient-to-r from-blue-200 via-red-300 to-green-200 ">
