        ...
        <div
          ...
          <div class="mx-48 border border-gray-400 p-4 rounded-md shadow-md">
            <div class=" mt-2  bg-indigo-200  rounded-md shadow-md mb-1 text-center">
              <h2 class="text-2xl font-bold text-center text-slate-500">Edit Category</h2>
            </div>
            ...
            if ($_SERVER['REQUEST_METHOD'] == 'POST') {
              $updateCategory = $category->updateCategory($_POST, $id);
            }

            $getCategoryId = $category->getCategoryById($id);
            if ($getCategoryId != null) {
              while ($categoryDetails = mysqli_fetch_assoc($getCategoryId)) {
                ?>
                <form method="post">
                  <div class="">
                    <div class="mb-4 mt-2 bg-gray-200 rounded p-2">
